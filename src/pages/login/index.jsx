            ...
            <div className="xl:ml-20 xl:w-5/12 lg:w-5/12 md:w-8/12 mb-12 md:mb-0">
              <form>
                <div class="flex items-center before:flex-1 before:border-t before:border-gray-300 before:mt-0.5 after:flex-1 after:border-t after:border-gray-300 after:mt-0.5">
                  <img src={logo} class="text-center h-1/3 w-1/3"></img>
                </div>
                {/* <!-- Email input --> */}
                <div for="email" className="mb-6">
                  <input
                    type="email"
                ...
                <div className="text-center lg:text-center">
                  ...
                  <p className="text-sm font-semibold mt-2 pt-1 mb-0">
                    ...
                    <label className="cursor-pointer text-red-600 hover:text-red-700 focus:text-red-700 transition duration-200 ease-in-out">
